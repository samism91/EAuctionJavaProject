...
<!-- register -->
   ...
   <div class="center_title_bar">Buyer's Registartion Form</div></br></br>
   <div class="prod_box_big">
     <div class="top_prod_box_big"></div>
     <div class="center_prod_box_big">
       <div class="contact_form">
         <form action="/eauction/BuyerServlet" method="post">
           <div class="form_row">
            <label class="contact"><strong>Buyer_Id:</strong></label>
           <input type="text" class="contact_input" required="required" name="buyer_id" />
         </div>
         <div class="form_row">
           <label class="contact"><strong>Email:</strong></label>
           <input type="email" class="contact_input" name="buyer_email" required="required" />
         </div>
         <div class="form_row">
           <label class="contact"><strong>Password:</strong></label>
           <input type="password" class="contact_input" name="buyer_password" required="required" />
         </div>
         <div class="form_row">
           <label class="contact"><strong>Retype Password:</strong></label>
           <input type="password" class="contact_input" name="buyer_repassword" required="required" />
         </div>
        <div class="form_row">
         ...
         <div class="form_row">
           ...
           <input type="tel" class="contact_input"  name="buyer_privacy_code" required="required" />
         </div>
         <p>&nbsp;</p>
         <p>&nbsp;</p>
         <div class="form_row">
