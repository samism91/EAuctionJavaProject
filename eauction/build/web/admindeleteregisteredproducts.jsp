<%-- 
    Document   : admindeleteregisteredproducts
    Created on : May 17, 2012, 11:07:07 PM
    Author     : Samkit
--%>
...
Connection con8 = null;
            ...
            Statement st8=null,
                 ...
                 int h = st8.executeUpdate("delete from Product_Registration1 where product_name='"+paramNames[i]+"'");
